...
export function parseCliArgs(argv: string[]): ParsedCli {
  ...
  return { command, overrides, configPath: values.config as string | undefined, fresh: values.fresh as boolean | undefined };
}
